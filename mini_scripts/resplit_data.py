...
train_labels = pd.read_csv('data/old_labels/train_labels.csv')
val_labels = pd.read_csv('data/old_labels/labels.csv')
test_labels = pd.read_csv('data/old_labels/test_labels.csv')
